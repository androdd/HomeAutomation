namespace HomeAutomation2.Hardware
{
    ...
    public class HardwareManager
    {
        ...
        public int AutoTurnOffHousePumpRelayId { get; private set; }
        public int AutoTurnOffGardenPumpRelayId { get; private set; }
        ...
        public HardwareManager(IStorage externalStorage)
        {
            ...
            AutoTurnOffGardenPumpRelayId = 5;
            AutoTurnOffHousePumpRelayId = 6;
            LightsRelayId = 7;
